...
import 'package:reline_notifications/src/utils/download_image.dart';
import 'package:reline_notifications/src/utils/types_def.dart';
...
void notificationTapBackground(NotificationResponse notificationResponse) {
  if (notificationResponse.payload != null) {
    ...
    _RelineNotificationsState._notificationHandler(
      message,
...
class RelineNotifications extends StatefulWidget {
  static bool enableLogs = !kReleaseMode;

  static String? get fcmToken => _RelineNotificationsState._fcmToken;

  static final openedAppFromNotification =
      _RelineNotificationsState._openedAppFromNotification;
  ...
  static void setOnTap(OnTapGetter? onTap) {
    _RelineNotificationsState._onTap = onTap;
  }

  static void setOnOpenNotificationArrive(
    OnOpenNotificationArrive? onOpenNotificationArrive,
  ) {
    _RelineNotificationsState._onOpenNotificationArrive =
  ...
  static void setShouldHandleNotification(
    ...
    _RelineNotificationsState._shouldHandleNotification =
  ...
  static const deleteAndroidNotificationChannelGroup =
      _RelineNotificationsState.deleteAndroidNotificationChannelGroup;
  ...
  static const getAndroidNotificationChannels =
      _RelineNotificationsState.getAndroidNotificationChannels;

  /// Re-initializes local notifications.
  static const reInitializeLocalNotifications =
      _RelineNotificationsState.reInitializeLocalNotifications;
  ...
  ///
  /// {@endtemplate}
  static const getInitialMessage = _RelineNotificationsState.getInitialMessage;
  static const requestFcmToken = _RelineNotificationsState.fcmToken;
  ...
  static Stream<NotificationInfoModel> get notificationTapsSubscription =>
      _RelineNotificationsState._notificationTapsSubscription.stream;
  ...
  static Stream<NotificationInfoModel> get notificationArrivesSubscription =>
      _RelineNotificationsState._notificationArriveSubscription.stream;
  ...
  @override
  State<RelineNotifications> createState() => _RelineNotificationsState();
}

class _RelineNotificationsState extends State<RelineNotifications> {
  ...
  static Future<String?> initializeFcmToken({String? vapidKey}) async {
    ...
    if (!isInitialized) {
      ...
      if (RelineNotifications.enableLogs) {
        if (kDebugMode) {
...
''';
  ...
  static Future<RemoteMessage?> getInitialMessage({
    ...
    if (RelineNotifications._initialMessageHandled) return null;

    RelineNotifications._initialMessageHandled = true;
