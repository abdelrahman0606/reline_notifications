...
typedef AndroidImportanceGetter = RelineNotificationsImportance Function(RemoteMessage);
typedef AndroidPriorityGetter = RelineNotificationsPriority Function(RemoteMessage message);
