...
class AndroidConfigModel {
  ...
  static RelineNotificationsImportance defaultImportance = RelineNotificationsImportance.max;
  ...
  ///
  /// {@endtemplate}
  static RelineNotificationsPriority defaultPriority =
      RelineNotificationsPriority.max;
  ...
  Importance _mapImportance(RelineNotificationsImportance importance) {
    switch (importance) {
      case RelineNotificationsImportance.min:
        return Importance.min;
      case RelineNotificationsImportance.low:
        return Importance.low;
      case RelineNotificationsImportance.defaultImportance:
        return Importance.defaultImportance;
      case RelineNotificationsImportance.high:
        return Importance.high;
      case RelineNotificationsImportance.max:
        return Importance.max;
    }
  }

  Priority _mapPriority(RelineNotificationsPriority priority) {
    switch (priority) {
      case RelineNotificationsPriority.min:
        return Priority.min;
      case RelineNotificationsPriority.low:
        return Priority.low;
      case RelineNotificationsPriority.defaultPriority:
        return Priority.defaultPriority;
      case RelineNotificationsPriority.high:
        return Priority.high;
      case RelineNotificationsPriority.max:
        return Priority.max;
    }
  }
